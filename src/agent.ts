...
class Assistant extends voice.Agent {
  constructor() {
    super({
      ...
      **絶対ルール**: 1文に必ず1つ以上のエモーションタグを配置してください。エモーションタグがない文章は生成しないでください。
      ...
      **重要なルール（必須遵守）:**
      - **絶対ルール**: すべての応答文に必ず1つ以上のエモーションタグを配置してください。エモーションタグがない文章は生成しないでください。
      ...
      - **チェック**: 応答を生成する前に、すべての文章にエモーションタグが含まれているか確認してください。
