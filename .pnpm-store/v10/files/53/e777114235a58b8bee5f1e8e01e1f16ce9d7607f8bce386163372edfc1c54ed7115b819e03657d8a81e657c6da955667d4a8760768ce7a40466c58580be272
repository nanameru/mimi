...
var DisconnectReason = /* @__PURE__ */ ((DisconnectReason2) => {
  ...
  DisconnectReason2[DisconnectReason2["CONNECTION_TIMEOUT"] = 14] = "CONNECTION_TIMEOUT";
  DisconnectReason2[DisconnectReason2["MEDIA_FAILURE"] = 15] = "MEDIA_FAILURE";
  return DisconnectReason2;
})(DisconnectReason || {});
import_protobuf.proto2.util.setEnumType(DisconnectReason, "livekit.proto.DisconnectReason", [
...
const _ParticipantInfo = class _ParticipantInfo extends import_protobuf.Message {
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_ParticipantInfo, a, b);
  }
};
_ParticipantInfo.runtime = import_protobuf.proto2;
_ParticipantInfo.typeName = "livekit.proto.ParticipantInfo";
_ParticipantInfo.fields = import_protobuf.proto2.util.newFieldList(() => [
...
const _OwnedParticipant = class _OwnedParticipant extends import_protobuf.Message {
  ...
  static equals(a, b) {
    return import_protobuf.proto2.util.equals(_OwnedParticipant, a, b);
  }
};
_OwnedParticipant.runtime = import_protobuf.proto2;
_OwnedParticipant.typeName = "livekit.proto.OwnedParticipant";
_OwnedParticipant.fields = import_protobuf.proto2.util.newFieldList(() => [
